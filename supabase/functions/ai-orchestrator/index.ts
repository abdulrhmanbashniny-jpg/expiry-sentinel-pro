...
`;
  ...
  prompt += `\n## ⚠️ قواعد استدعاء الأدوات (حرجة):
- **لا تستدعِ أي أداة** للأسئلة المحادثية، التحيات، أو الأسئلة عن هويتك/دورك/قدراتك.
- **لا تستدعِ أي أداة** عندما يسأل المستخدم "ما هو دورك؟"، "كيف تعمل؟"، "ماذا تستطيع أن تفعل؟"، "مرحبا"، "شكرا"، أو أي سؤال عام لا يتطلب بيانات.
- **استدعِ الأدوات فقط** عندما يطلب المستخدم صراحةً: تحليل بيانات، فحص سجلات، إرسال رسائل، توقع مخاطر، أو تنفيذ إجراء محدد.
- إذا كان السؤال يمكن الإجابة عليه من معرفتك النظامية (System Prompt) بدون بيانات حية، أجب مباشرة بدون أدوات.
